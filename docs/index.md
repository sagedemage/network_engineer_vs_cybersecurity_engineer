...
<p class="list-info">Some responsiblilites of Network Engineers:</p>
...
<p class="list-info">Some responsibilities of Cybersecurity Engineers:</p>
...
<p class="list-info">Certifications for Network Engineers:</p>

- CCNA (Recommended)
- CompTIA Network+

<p class="list-info">Certifications for Cybersecurity Engineers:</p>
